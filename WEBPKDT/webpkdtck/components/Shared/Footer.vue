      ...
      <div class="row">
        <div class="col-12 col-md">
          <img
            ...
            height="24"
          />
          <small class="d-block mb-3 text-muted">&copy;Phukiendienthoai</small>
          <small class="d-block mb-3 text-muted"
            >&copy;Mở cửa từ 8h AM đến 22 PM tất cả các ngày trong tuần</small
          >
        </div>
          ...
          <ul class="list-unstyled text-small">
            <li>
              <a class="text-muted" href="#"
                >Số 129, đường Phạm Như Xương, thành phố Đà Nẵng</a
              >
            </li>
          </ul>
        </div>
